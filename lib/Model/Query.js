...
Query.prototype.fetch = function(cb) {
  ...
  var timestamp2 = timestamp1 - startTime;
  console.log('model.shareConnection.createFetchQuery = ', timestamp1, ' ms');
  console.log('model.shareConnection.createFetchQuery = ', timestamp2, ' ms');
  ...
  function fetchQueryCallback(err, results, extra) {
    console.log('fetchQueryCallback = ', (+new Date()) - startTime, ' ms');
    console.log('fetchQueryCallback = ', (+new Date()), ' ms');
